...
// const Home: React.FC = () => {
//     return (
//         <div className="relative w-full h-96 sm:h-96 md:h-screen bg-gradient-to-l from-[#6970f0] to-[#4e54c8] ">
//             <div className="absolute top-1/3 w-full transform -translate-y-1/2">
//                 <TextAninmation name="Maity Enterprise" />
//             </div>
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <section className="bg-white py-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <NavLink to="/Maity-Enterprice/Plans">
